...
int main(int argc, char** argv) {
    ...
    auto run_and_output = [&](const string &which_algo) {
        vector<int> topo;
        ...
        if (format == "json") {
            ...
            if (which_algo == "dfs" || which_algo == "kahn") cerr << "Algorithm: " << which_algo << "  Time(ms): " << ms << "\n";
            cout << "h:";
            for (int v : h) cout << ' ' << v;
            cout << '\n';
            cout << "list:";
            ...
            cout << '\n';
            if (has_cycle) cout << "Graph has a cycle; topological order does not exist.\n";
            else {
